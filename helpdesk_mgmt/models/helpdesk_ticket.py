...
class HelpdeskTicket(models.Model):
    ...
    #     ('7_14', '7 - 14 Days'),
    #     ('15_29', '15 - 29 Days'),
    #     ('30_plus', 'Unacceptable > 30 Days'),
    # ], compute='_compute_aging_bucket', store=True)
    ...
    #     for rec in self:
    #         if rec.create_date:
    #             age = (today - rec.create_date.date()).days
    #             if age <= 6:
    #                 rec.aging_bucket = '0_6'
    #             elif age <= 14:
    #                 rec.aging_bucket = '7_14'
    #             elif age <= 29:
    #                 rec.aging_bucket = '15_29'
    #             else:
    #                 rec.aging_bucket = '30_plus'
    #         else:
