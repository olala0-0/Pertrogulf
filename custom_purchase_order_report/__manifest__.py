{
    ...
    'version': '19.0.1.0.0',
    'category': 'Purchases',
    'summary': 'Petro Gulf Ajman-branded Purchase Order PDF layout',
    'description': """
        ...
        line items table, Amount in Words, signatory footer).

        Only available for purchase orders whose company is Petro Gulf
        Ajman (business_unit = 'pg_ajman') or one of its direct branch
        companies - printing it for any other company raises an error
        instead of generating the PDF.
    """,
    'depends': ['purchase', 'zilancer_customisation'],
    'data': [
